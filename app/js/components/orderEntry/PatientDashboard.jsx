          ...
          <section className="col-lg-12 col-md-12 col-sm-12">
            <div className="row">
              ...
              <div className="col-lg-1 col-md-1 col-sm-1"
                style={{ marginTop: "10px", paddingLeft: "0", paddingRight: "0", fontSize: "14px" }}>
                <p> Female </p>
              </div>
              ...
              <div className="col-lg-2 col-md-2 col-sm-2"
                style={{ marginTop: "14px", paddingLeft: "0", paddingRight: "0", fontSize: "12px" }}>
                <a style={{ paddingRight: "4px" }}> Edit </a>
                <a> Show Contact Info </a>
              </div>
              <div className="col-lg-2 col-md-2 col-sm-2 col-sm-offset-2 col-md-offset-2 col-lg-offset-2 text-right"
