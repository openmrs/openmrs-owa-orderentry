...
describe('createOrder reducer test suite', () => {
  ...
  error message from payload on action type SAVE_ORDER_FAILURE `, () => {
    const action = {
  ...
  it(`parses data from payload to key orderData and sets staus key
  added to true on action type SAVE_ORDER_SUCCESS `, () => {
    const data = {
      id: 1,
      name: 'Lab order',
  ...
  it('should handle SAVE_ORDER_LOADING', () => {
    const action = {
